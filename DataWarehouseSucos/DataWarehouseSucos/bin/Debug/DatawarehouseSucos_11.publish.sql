...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Dim_Cliente] ([Cod_Cliente], [Desc_Cliente], [Cod_Cidade], [Desc_Cidade], [Cod_Estado], [Desc_Estado], [Cod_Regiao], [Desc_Regiao], [Desc_Segmento])
        SELECT   [Cod_Cliente],
                 [Desc_Cliente],
                 [Cod_Cidade],
                 [Desc_Cidade],
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Dim_Tempo])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Dim_Tempo] ([Cod_Dia], [Data], [Cod_Semana], [Nome_Dia_Semana], [Cod_Mes], [Nome_Mes], [Cod_Mes_Ano], [Cod_Trimestre], [Nome_Trimestre], [Cod_Trimestre_Ano], [Nome_Trimestre_Ano], [Cod_Semestre], [Cod_Semestre_Ano], [Nome_Semestre_Ano], [Ano], [Tipo_Dia], [Nome_Mes_Ano])
        SELECT   [Cod_Dia],
                 [Data],
                 [Cod_Semana],
                 [Nome_Dia_Semana],
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Fato_001])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Fato_001] ([Cod_Cliente], [Cod_Produto], [Cod_Organizacional], [Cod_Fabrica], [Cod_Dia], [Faturamento], [Custo_Variavel], [Quantidade_Vendida], [Unidade_Vendida], [Imposto])
        SELECT   [Cod_Cliente],
                 [Cod_Produto],
                 [Cod_Organizacional],
                 [Cod_Fabrica],
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Fato_002])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Fato_002] ([Cod_Cliente], [Cod_Produto], [Cod_Fabrica], [Cod_Dia], [Frete])
        SELECT   [Cod_Cliente],
                 [Cod_Produto],
                 [Cod_Fabrica],
                 [Cod_Dia],
                 [Frete]
        FROM     [dbo].[Fato_002]
        ORDER BY [Cod_Cliente] ASC, [Cod_Produto] ASC, [Cod_Fabrica] ASC, [Cod_Dia] ASC;
    END
...
GO
PRINT N'Starting rebuilding table [dbo].[Fato_004]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Fato_004] (
    [Cod_Cliente]        NVARCHAR (50) NOT NULL,
    [Cod_Produto]        NVARCHAR (50) NOT NULL,
    [Cod_Organizacional] NVARCHAR (50) NOT NULL,
    [Cod_Dia]            NVARCHAR (50) NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Fato_004])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Fato_004] ([Cod_Cliente], [Cod_Produto], [Cod_Organizacional], [Cod_Dia], [Meta_Faturamento])
        SELECT   [Cod_Cliente],
                 [Cod_Produto],
                 [Cod_Organizacional],
                 [Cod_Dia],
                 [Meta_Faturamento]
        FROM     [dbo].[Fato_004]
        ORDER BY [Cod_Cliente] ASC, [Cod_Produto] ASC, [Cod_Organizacional] ASC, [Cod_Dia] ASC;
    END

DROP TABLE [dbo].[Fato_004];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Fato_004]', N'Fato_004';
...
GO
PRINT N'Starting rebuilding table [dbo].[Fato_005]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Fato_005] (
    [Cod_Produto] NVARCHAR (50) NOT NULL,
    [Cod_Fabrica] NVARCHAR (50) NOT NULL,
    [Cod_Dia]     NVARCHAR (50) NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Fato_005])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Fato_005] ([Cod_Produto], [Cod_Fabrica], [Cod_Dia], [Meta_Custo])
        SELECT   [Cod_Produto],
                 [Cod_Fabrica],
                 [Cod_Dia],
                 [Meta_Custo]
        FROM     [dbo].[Fato_005]
        ORDER BY [Cod_Produto] ASC, [Cod_Fabrica] ASC, [Cod_Dia] ASC;
    END

DROP TABLE [dbo].[Fato_005];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Fato_005]', N'Fato_005';
